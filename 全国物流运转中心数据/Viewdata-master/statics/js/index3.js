$(function () {
    ...
    function char_1() {
        ...
        $.ajax({
            url:"http://127.0.0.1:5000/index3/char1_2",
    ...
    function char_3() {
        ...
        $.ajax({
            url:"http://127.0.0.1:5000/index3/char3",
            success:function(data){
                let seriesLineData = []
                let LineData = [{
                    name: '破损件',
    ...
    function char_4() {
        ...
        $.ajax({
            url:"http://127.0.0.1:5000/index3/maps",
            success:function(data){
    ...
    function char_5() {
        ...
        $.ajax({
            url:"http://127.0.0.1:5000/index3/chart5",
            success:function(data){
                option = {
    ...
    function char_6() {
        ...
        $.ajax({
            url:"http://127.0.0.1:5000/index3/chart6",
    ...
    function char_8() {
        ...
        $.ajax({
            url:"http://127.0.0.1:5000/index3/chart8",
            success:function(data){
                option = {
